...
// (in-package analytic_solver.srv)
...
class analyticRequest {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type analyticRequest
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type analyticRequest
    let len;
    let data = new analyticRequest(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new analyticRequest(null);
    if (msg.a !== undefined) {
      resolved.a = msg.a;
    }
    else {
...
class analyticResponse {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type analyticResponse
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type analyticResponse
    let len;
    let data = new analyticResponse(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new analyticResponse(null);
...
module.exports = {
  ...
  datatype() { return 'analytic_solver/analytic'; }
};
