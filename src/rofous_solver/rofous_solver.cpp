...
Pose3D Analytic_Solver::quadcopter_throttle_to_force(Pose3D pose, vector<float> throttle, float radius)
{
	vector<float> thrust = 
	{
...
void Analytic_Solver::update_3D_odometry(Pose3D* pose, Pose3D* speed, Pose3D acceleration, float t)
{
